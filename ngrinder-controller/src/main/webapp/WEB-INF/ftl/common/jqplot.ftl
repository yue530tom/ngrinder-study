...
<script src="${req.getContextPath()}/plugins/jqplot/js/jquery.jqplot.min.js?${nGrinderVersion}"></script>
<script src="${req.getContextPath()}/plugins/jqplot/js/excanvas.min.js?${nGrinderVersion}"></script>
